...
public class ChannelControllerTest {
    ...
    void updateChannel_Failure_ChannelNotFound() throws Exception {
        ...
        given(channelService.updateChannel(eq(nonExistingChannelId), any(PublicChannelUpdateRequest.class)))
                .willThrow(ChannelNotFoundException.withId(nonExistingChannelId));

        //when & then
        mockMvc.perform(patch("/api/channels/{channelId}", nonExistingChannelId)
                        .contentType(MediaType.APPLICATION_JSON)
                        .content(objectMapper.writeValueAsString(updateRequest)))
    ...
    void updateChannel_Failure_PrivateChannelUpdate() throws Exception {
        ...
        given(channelService.updateChannel(eq(privateChannelId), any(PublicChannelUpdateRequest.class)))
    ...
    void deleteChannel_Success() throws Exception {
        //given
        UUID channelId = UUID.randomUUID();
        willDoNothing().given(channelService).deleteChannel(eq(channelId));
    ...
    void findAllByUserId_Success() throws Exception {
        ...
        given(channelService.findAllChannelsByUserId(userId)).willReturn(channels);
