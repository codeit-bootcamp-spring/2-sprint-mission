...
class AuthServiceTest {
  ...
  void setUp() {
    ...
    userService.register(new UserCreateRequest(LOGIN_USER.getName(), LOGIN_USER.getEmail(),
  ...
  void loginUpdatesUserStatus() {
    LoginRequest loginRequestUser = new LoginRequest(LOGIN_USER.getName(),
  ...
  void loginThrowsExceptionForUnregisteredUser() {
    LoginRequest loginRequestUser = new LoginRequest(OTHER_USER.getName(),
