...
public class BasicMessageServiceTest {
    ...
    @Test
    @DisplayName("정상적인 Message 생성 성공")
    ...
    @Test
    @DisplayName("존재하지 않는 userId로 메세지 생성 시 예외 발생")
    ...
    void findMessage_Success() {
        ...
        //when
        MessageDto result = messageService.searchMessage(messageId);
    ...
    @Test
    @DisplayName("존재하지 않는 메세지 조회 시 실패")
    void findMessage_WithInvalidMessageId_ThrowException() {
        //given
        given(messageRepository.findById(eq(messageId))).willReturn(Optional.empty());

        //when & then
        assertThatThrownBy(() -> messageService.searchMessage(messageId))
    ...
    @Test
    @DisplayName("존재하지 않는 messageId로 업데이트 시 예외 발생")
    ...
    @Test
    @DisplayName("정상적인 Message 삭제 성공")
    ...
    @Test
    @DisplayName("존재하지 않는 messageId로 삭제 시 예외 발생")
