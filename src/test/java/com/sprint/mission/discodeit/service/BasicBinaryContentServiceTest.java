...
public class BasicBinaryContentServiceTest {
    ...
    void createBinaryContent_WithValidInput_Success() {
        //given
    ...
    void findBinaryContent_WithInvalidBinaryContentId_ThrowException() {
        //given
    ...
    void findAllByIdIn_Success() {
        ...
        BinaryContent content2 = new BinaryContent("file2.jpg", 200L, "image/jpeg");
        ...
        BinaryContentDto dto2 = new BinaryContentDto(id2, "file2.jpg", 200L, "image/jpeg");
    ...
    void deleteBinaryContent_WithValidInput_Success() {
        //given
        given(binaryContentRepository.existsById(eq(binaryContentId))).willReturn(true);
    ...
    void deleteBinaryContent_WithInvalidBinaryContentId_ThrowException() {
        //given
