...
class UserControllerTest extends ControllerTestSupport {
  ...
  void register_Validation(String name, String email, String password, String expectedMessage) {
    ...
    UserCreateRequest userCreateRequest = new UserCreateRequest(name, email, password);
    MockMultipartFile multipartFile = new MockMultipartFile("userCreateRequest", null,
        MediaType.APPLICATION_JSON_VALUE, convertJsonRequest(userCreateRequest).getBytes());
  ...
  static Stream<Arguments> invalidUserProvider() {
    return Stream.of(
        ...
        Arguments.of("a", "test@naver.com", "12345678", "이름은 2~20자 이내여야 합니다."),
        // username too short
        Arguments.of("validname", "invalid-email", "12345678",
            "must be a well-formed email address"), // email invalid
        Arguments.of("validname", "test@naver.com", "", "아이디는 필수입니다."), // password blank
        Arguments.of("validname", "test@naver.com", "short", "비밀번호는 8~30자 이내여야 합니다.")
        // password too short
    );
  }
