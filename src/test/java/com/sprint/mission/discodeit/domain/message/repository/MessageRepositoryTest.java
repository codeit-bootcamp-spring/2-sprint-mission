...
class MessageRepositoryTest extends IntegrationTestSupport {
  ...
  void findLastMessageCreatedAtByChannelId() {
    ...
    Channel channel = channelRepository.save(Channel.createPublic("", ""));
    ...
    // when
    Optional<Message> lastMessageCreatedAtByChannelId = messageRepository.findLastMessageCreatedAtByChannelId(
        channel.getId());
