...
public enum ErrorCode {
    ...
    CHANNEL_ALREADY_EXISTS(409, "C002", "Channel already exists."),
    ...
    READ_STATUS_ALREADY_EXISTS(409, "R002", "Read status already exists."),

    // UserStatus
    USER_STATUS_NOT_FOUND(404, "US001", "UserStatus not found."),
    USER_STATUS_ALREADY_EXISTS(409, "US002", "UserStatus already exists."),

    // Auth
    INVALID_PASSWORD(401, "A001", "Password is invalid."),
