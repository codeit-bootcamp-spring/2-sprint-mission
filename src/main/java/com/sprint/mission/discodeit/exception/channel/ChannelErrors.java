...
public final class ChannelErrors {
  ...
  public static final String NULL_POINT_CHANNEL_ID = "Channel ID is null";
  ...
  public static NullPointChannelIdError nullPointChannelIdError() {
    throw new NullPointChannelIdError(NULL_POINT_CHANNEL_ID);
  }
