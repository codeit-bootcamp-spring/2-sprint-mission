...
public class TestJavaApplication {
    static User setupUser(UserService userService) {
        return userService.createUser("woody");
    }
    ...
    static void messageCreateTest(MessageService messageService, Channel channel, User user) {
        Message message = messageService.createMessage(user.getId(), channel.getId(), "안녕하세요.");
...
//        MessageRepository1 messageRepository = new JCFMessageRepository();
