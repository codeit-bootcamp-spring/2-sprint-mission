...
public class ReadStatusController implements ReadStatusApi {
    ...
    public ResponseEntity<ReadStatusDto> create(
        ...
        ReadStatusDto createdReadStatus = readStatusService.create(request, principal);
    ...
    public ResponseEntity<ReadStatusDto> update(
        ...
        ReadStatusDto updatedReadStatus = readStatusService.update(readStatusId, request, principal);
