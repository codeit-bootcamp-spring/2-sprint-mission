...
public class FileChannelRepository implements ChannelRepository {
    ...
    private void dataLoad() {
        ...
        try (ObjectInputStream ois = new ObjectInputStream(new FileInputStream(channelFilePath.toFile()))) {
    ...
    private void dataSave() {
        try (ObjectOutputStream oos = new ObjectOutputStream(new FileOutputStream(channelFilePath.toFile()))) {
