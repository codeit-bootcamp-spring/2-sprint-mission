...
public interface ChannelApi {
    ...
    @Operation(
        ...
        responses = {
            @ApiResponse(responseCode = "201", description = "Public Channel이 성공적으로 생성됨", content = {
                @Content(mediaType = "*/*", schema = @Schema(implementation = Channel.class))
            })
        }
    )
    @RequestMapping(
    ...
    default ResponseEntity<Channel> create3(
        @Parameter(name = "PublicChannelCreateRequest", description = "", required = true) @Valid
        @RequestBody
        ...
        getRequest().ifPresent(request -> {
            for (MediaType mediaType: MediaType.parseMediaTypes(request.getHeader("Accept"))) {
                if (mediaType.isCompatibleWith(MediaType.valueOf("*/*"))) {
                    String exampleString = "{ \"createdAt\" : \"\", \"name\" : \"\", \"description\" : \"\", \"id\" : \"\", \"type\" : \"\", \"updatedAt\" : \"\" }";
    ...
    default ResponseEntity<Channel> create4(
     ...
     * @return Channel을 찾을 수 없음 (status code 404)
     *         or Channel이 성공적으로 삭제됨 (status code 204)
     */
    @Operation(
        operationId = "delete2",
        summary = "Channel 삭제",
     ...
     * @return Channel을 찾을 수 없음 (status code 404)
     *         or Private Channel은 수정할 수 없음 (status code 400)
     *         or Channel 정보가 성공적으로 수정됨 (status code 200)
     */
    @Operation(
        operationId = "update3",
    ...
    default ResponseEntity<Channel> update3(
