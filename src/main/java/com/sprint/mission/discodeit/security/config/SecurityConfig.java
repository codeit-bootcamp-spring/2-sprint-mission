...
import com.sprint.mission.discodeit.security.filter.CustomAccessDeniedHandler;
...
import com.sprint.mission.discodeit.security.filter.JwtTokenLogoutHandler;
...
public class SecurityConfig {
  ...
  public SecurityFilterChain configure(
      ...
      UserSelfAuthorizationManager userAuthorizationManager,
      ...
      ReadStatusSelfAuthorizationManager readStatusAuthorizationManager,
    ...
    httpSecurity
        .authorizeHttpRequests(auth -> auth
            ...
            .requestMatchers(USER_DELETE, USER_UPDATE).access(userAuthorizationManager)
            ...
            .requestMatchers(READ_STATUS_CREATE, READ_STATUS_UPDATE).access(readStatusAuthorizationManager)
        ...
        .logout(logout -> logout
            ...
            .addLogoutHandler(new JwtTokenLogoutHandler(jwtService))
        )
        .csrf(csrf -> csrf
