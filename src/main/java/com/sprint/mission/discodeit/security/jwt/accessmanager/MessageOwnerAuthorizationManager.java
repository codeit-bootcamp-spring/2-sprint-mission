...
public class MessageOwnerAuthorizationManager implements
  ...
  public AuthorizationDecision check(
    ...
    return messageRepository.findByMessageId(UUID.fromString(messageId))
        .map(message -> currentUserId.equals(message.getUser().getId()))
