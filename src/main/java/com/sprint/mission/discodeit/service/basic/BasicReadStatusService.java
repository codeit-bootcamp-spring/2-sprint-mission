...
public class BasicReadStatusService implements ReadStatusService {
    ...
    public void createReadStatus(UUID userId, UUID channelId) {
        ...
        ReadStatus existingReadStatus = readStatusRepository.findReadStatusById(channelId, userId);
    ...
    public ReadStatus findReadStatusById(UUID userId, UUID channelId) {
        ReadStatus readStatus = readStatusRepository.findReadStatusById(userId, channelId);
        if (readStatus == null) {
