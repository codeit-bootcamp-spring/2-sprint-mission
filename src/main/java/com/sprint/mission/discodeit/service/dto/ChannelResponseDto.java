...
public record ChannelResponseDto(
    ...
    public static ChannelResponseDto convertToResponseDto(Channel channel, Set<UUID> channelMembers, Instant lastMessageCreatedAt) {
        return new ChannelResponseDto(channel.getId(), channel.getType(), channel.getCategory(), channel.getName(), channelMembers, channel.getWritePermission(), lastMessageCreatedAt);
    }
}
