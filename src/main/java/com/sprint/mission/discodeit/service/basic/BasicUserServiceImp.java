...
public class BasicUserServiceImp implements UserService {
  ...
  public UserCreateResponse register(UserCreateRequest userCreateRequest,
    ...
    if (userRepository.existsByUsername(username)) {
      throw new IllegalArgumentException(
          "[register] User with username " + username + " already exists");
    }
    ...
    UserCreateResponse createdUserDto = new UserCreateResponse(user.getUsername(), user.getEmail(),
        user.getProfileId(), user.getId(), user.getCreatedAt(), user.getUpdatedAt());
  ...
  public User update(UUID userId, UserUpdateRequest userUpdateRequest,
    ...
    UUID nullableProfileId = optionalProfileCreateRequest
        .map(req -> updateProfileImage(user, req))
        .orElse(null);
  ...
  private UUID updateProfileImage(User user, BinaryContentCreateRequest request) {
    Optional.ofNullable(user.getProfileId())
        .ifPresent(binaryContentRepository::deleteById);
