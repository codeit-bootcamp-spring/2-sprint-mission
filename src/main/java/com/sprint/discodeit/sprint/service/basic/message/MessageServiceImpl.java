...
import com.sprint.discodeit.sprint.domain.mapper.MessageMapperV1;
...
public class MessageServiceImpl implements MessageService {
    ...
    private final MessageMapperV1 messageMapperV1;

    @Override
    public MessageResponseDto create(Long channelId, MessageRequestDto messageRequestDto) {
        ...
        return messageMapperV1.toMessageResponseDto(message);
    }
    ...
    @Override
    public MessageUpdateResponseDto update(Long messageId, MessageUpdateRequestDto messageUpdateRequestDto) {
        ...
        return messageMapperV1.toMessageUpdateResponseDto(message);
    }
